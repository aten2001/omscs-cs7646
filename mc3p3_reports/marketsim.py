...
def test_code():
    ...
    cum_ret_bench, avg_daily_ret_bench, std_daily_ret_bench, sharpe_ratio_bench = [compute_cr(portvals_benchmark),
                                                                                   compute_avg_daily_return(daily_rets_benchmark),
                                                                                   compute_sddr(daily_rets_benchmark),
                                                                                   compute_sr(daily_rets_benchmark, 0, 252)]
    ...
    print "Standard Deviation of Benchmark : {}".format(avg_daily_ret_bench)
    print
    print "Average Daily Return of Fund: {}".format(avg_daily_ret)
    print "Average Daily Return of Benchmark : {}".format(std_daily_ret_bench)
    print
